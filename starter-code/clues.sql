...
--returned Holy See (Vatican Cities State) | VAT
...
SELECT * FROM countries JOIN countrylanguages ON countries.code=countrylanguages.countrycode WHERE language = 'Italian' AND isofficial = true AND percentage = 100;

--returned  SMR  | San Marino
...
SELECT cities.name, countrycode, countries.name
    FROM cities
...
--returns Serra | BRA | Brazil

-- Clue #6: We're close! Our South American agent says she just got a taxi at the airport, and is headed towards
 -- the capital! Look up the country's capital, and get there pronto! Send us the name of where you're headed and we'll
 -- follow right behind you!

SELECT code, name, capital FROM countries WHERE code = 'BRA';
-- returns BRA  | Brazil | 211
